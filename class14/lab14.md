...
RNA Seq experiemtnt to knock out HOX gene
...
```
    ...
    2 standardGeneric("metadata"), generic = structure("metadata", package = "S4Vectors"), 
    3     package = "S4Vectors", group = list(), valueClass = character(0),                
...
\##Extract the results Big table with log2 fold changes and p-values
...
![](lab14_files/figure-commonmark/unnamed-chunk-13-1.png)

## Add Annotation

Add gene symbols and entrez ids

> QQ. Use the mapIDs() function multiple times to add SYMBOL, ENTREZID
...
```
    ...
    Info: Working in directory /Users/niamshasha/Desktop/BIMM143/bimm143_github/class14
...
The pathway with the most significant Entities p-value was related to
cell cycle processes. This matches the KEGG output as cell cycle was
down-regulated which further suggests that HOXA1 knockdown strongly
affects the cell cycle. Factors that could cause differences between the
two methods could arise from differences from differing database
organization, different annotations, different gene sets/pathways.
